...
<head>
    ...
    <script type="text/javascript" src="<c:url value="/resources/js/jquery-ui.1.12.1.js" />"></script>
    <script>
...
<body>
    <div id="header" align="center">
        <a href="../SpringMvcJdbcGradle/index"><img src="<c:url value="/resources/images/home.png" />" width="35px" ></a>
